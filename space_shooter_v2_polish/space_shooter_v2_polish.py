...
explosion_img = pygame.transform.scale(pygame.image.load('explosion.gif'),(100,100))
...
player2_img = pygame.transform.scale(pygame.image.load('p2plane.png'),(100,100))
...
class Player:
    ...
    def draw(self):
        ...
        if self.name == "P1":
            screen.blit(player_img,(self.pos[0]-30,self.pos[1]-self.width/2-40))
        elif self.name == "P2":
            screen.blit(player2_img,(self.pos[0]-30,self.pos[1]-self.width/2-40))
    def shoot_bullets(self):
        global bullet_list
        global is_key_pressed
        #print('shoot bullet')
        shoot_sound.play()
        bullet_list.append([int(self.pos[0]),int(self.pos[1]),self.name])
...
class Enemy:
    ...
    def draw(self):
        pygame.draw.circle(screen,self.colour,self.pos,self.width,0)
        screen.blit(enemy_img,(self.pos[0]-50,self.pos[1]-60))
        ...
        for i, bullet in enumerate(bullet_list):
            try:
                if abs(self.pos[1] - bullet[1]) < self.width >0 and abs(self.pos[0] - bullet[0]) < self.width > 0:
                    #screen.blit(explosion_img,self.pos[0],self.pos[1])
                    #print('del called')
                    self.__del__()
