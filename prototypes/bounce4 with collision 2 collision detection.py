...
def collision_detection():
    global start
    #global gameover
    #if abs(player_ball_pos[0]) - abs(ball_1_pos[0]) < ball_width or abs(player_ball_pos[1]) - abs(ball_1_pos[1]) < ball_width :
...
while finished == False:
    ...
    if main_menu == False and start == True:
        ...
        collision_detection()
        printdetails()
    #if gameover == True and start == False:
    #    headerfont = pygame.font.SysFont("monospace", 30)
