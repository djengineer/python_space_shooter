...
mainmenu_img = pygame.image.load('mainmenu.jpg')
...
while finished == False:
    ...
    if start == False and main_menu == True:
        ...
        header = headerfont.render("Main Menu",1, (0,0,0))
        ...
        if winner == "p1":
            ...
            header = headerfont.render("P1 wins. 'Space' to Start",1, (0,0,0))
            screen.blit(header, (screenheight/2-150,screenheight/2-50))
        if winner == "p2":
            headerfont = pygame.font.SysFont("monospace", 60)
            header = headerfont.render("P2 wins. 'Space' to Start",1, (0,0,0))
            screen.blit(header, (screenheight/2-150,screenheight/2-50))
